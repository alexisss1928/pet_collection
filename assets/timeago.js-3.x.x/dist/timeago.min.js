!(function (t, e) {
  "object" == typeof module && module.exports
    ? ((module.exports = e()), (module.exports.default = module.exports))
    : (t.timeago = e());
  ...
  function n(t, n, r) {
    n = l[n] ? n : l[r] ? r : "en";
    for (
      var o = 0, i = t < 0 ? 1 : 0, a = (t = Math.abs(t));
      t >= p[o] && o < h;
      o++
    )
      t /= p[o];
  ...
  var f = "second_minute_hour_day_week_month_year".split("_"),
    ...
    w = {};
  return (
    (c.prototype.doRender = function (t, e, i) {
      var a,
        c = r(e, this.nowDate),
        d = this;
      (t.innerHTML = n(c, i, this.defaultLocale)),
        (w[
          (a = setTimeout(function () {
            d.doRender(t, e, i), delete w[a];
          }, Math.min(1e3 * o(c), 2147483647)))
        ] = 0),
        u(t, a);
    }),
